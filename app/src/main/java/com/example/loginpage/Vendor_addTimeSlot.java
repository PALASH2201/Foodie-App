...
public class Vendor_addTimeSlot extends AppCompatActivity {
   ...
   boolean checkBoxSelected = false;
     ...
     //   Log.d("Got rest id",restaurant_id);
      ...
      //  Log.d("Got rest name",restaurant_name);
        ...
        add_slot_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EditText availableSlots = findViewById(R.id.availableSlots);
                ...
                if(same_time_everyday_checkbox.isChecked() && checkBoxSelected){
                    Log.d("sending rest name",restaurant_name);
                      addTimeSlotEveryDay(daysOfWeek,selectedTimeSlot,available_slots,restaurant_id,restaurant_name);
                 }
                 else{
                    Log.d("sending rest name",restaurant_name);
                     addTimeSlot(selectedDay,selectedTimeSlot,available_slots,restaurant_id,restaurant_name);
                 }
            }
        });
    }
    public void addTimeSlot(String day , String timeSlot , String available_slots,String restaurant_id,String restaurant_name){
        ...
        timeSlotRef.child("available_slots").setValue(available_slots).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void unused) {
                dialog.dismiss();
                Toast.makeText(Vendor_addTimeSlot.this,available_slots+" slots added for "+timeSlot+" for "+day,Toast.LENGTH_SHORT).show();
            }
    ...
    public void addTimeSlotEveryDay(String[] days,String timeSlot , String available_slots,String restaurant_id,String restaurant_name){
        for (String day : days) {
            addTimeSlot(day, timeSlot, available_slots, restaurant_id, restaurant_name);
        }
    }
}
