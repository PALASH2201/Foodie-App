...
public class UserOrderHistoryDataClass {
    ...
    public UserOrderHistoryDataClass(String day, String orderId, String orderTime, String timeSlot, String totalBill, Map<String,List<UserOrderHistoryDishDataClass> > dishes) {
        this.day = day;
